...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "ZUGCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"zugsoft.com", "node1.zugsoft.com"},
    {"zugsoft.com", "node2.zugsoft.com"},
	{"zugsoft.com", "node3.zugsoft.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. ZUGCoin is probably already running."), addrBind.ToString().c_str());
        else
